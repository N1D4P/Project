    ...
    <footer class="footer">
      <div class="container">
        ...
        <div class="footer__payments">
          <a href="#">
            <svg src="/images/icon-facebook.svg" width="20" height="20">
          ...
          <a href="#">
            <svg src="/images/icon-youtube.svg" width="21" height="20">
              <title>YouTube</title>
              <path
                fill="#FFF"
          ...
          <a href="#">
            <svg src="/images/icon-twitter.svg" width="21" height="18">
              <title>Twitter</title>
              <path
                fill="#FFF"
          ...
          <a href="#">
            <svg src="/images/icon-pinterest.svg" width="20" height="20">
          ...
          <a href="#">
            <svg src="/images/icon-instagram.svg" width="21" height="20">
        ...
        <div class="footer__copyright">
          &copy; MovieTime. Tous droits réservés.
        </div>
      </div>
    </footer>
